...
The fixture manifest decides what gets served. If you add a section, view or
chart to it, add the matching file to `ROUTES` in `fixtures.ts`; staging stops
and names anything the manifest lists that it could not write.
