"""Tests for the codeowner_workflow_analysis module."""
...
def test_runner_records_to_dataframe():
    ...
    records = [
        RunnerRecord(
            repo="hiero-sdk", workflow_file="ci.yml", job_name="test", runner="hl-sdk-py-lin-md", is_self_hosted=True
        )
    ]
